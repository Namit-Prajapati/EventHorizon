...
const EditAcadmicEventPage = ({ route }) => {

    const navigator = useNavigation();

    const { item } = route.params;
    console.log(item);
    const checkedLabels = item.targetedDept;
    ...
    const HandleSubmit = async () => {
        ...
        const apiUrl = `${API_IP}admin/editacadevent/${item._id}`;
    ...
    return (
        <ScrollView style={styles.container}>
            <Text style={styles.heading}>Edit Acadmic Event</Text>
...
export default EditAcadmicEventPage;